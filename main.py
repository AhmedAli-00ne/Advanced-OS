...
class App(tk.Tk):
    ...
    def create_widgets_buttons(self,pos):
        ...
        self.clear_wndow()
        self.FCFSButton = tk.Button(self, text="FCFS", command=lambda: self.PerformAlgorithm(1))
        self.FCFSButton.pack()
        self.C_LookButton = tk.Button(self, text="C-Look", command=lambda: self.PerformAlgorithm(2))
        self.C_LookButton.pack()
        self.LRUButton = tk.Button(self, text="LRU", command=lambda: self.PerformAlgorithm(3))
        self.LRUButton.pack()
        self.SecondChanceButton = tk.Button(self, text="Second Chance", command=lambda: self.PerformAlgorithm(4))
        self.SecondChanceButton.pack()
        self.BackButton = tk.Button(self, text="Back", command=self.create_widgets)
    ...
    def create_widgets(self):
        ...
        self.req_queue.pack()
        self.start_btn = tk.Button(self, text="Start", command=lambda:self.create_widgets_buttons(0))
        self.start_btn.pack()
